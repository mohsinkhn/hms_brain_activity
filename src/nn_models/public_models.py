...
class EEGNet(nn.Module):
    ...
    def __init__(self, kernels, in_channels=20, fixed_kernel_size=17, num_classes=6):
        ...
        self.fc = nn.Linear(in_features=128 * 2 + 24 * 7, out_features=num_classes)
        self.rnn1 = nn.GRU(
            input_size=156, hidden_size=156, num_layers=1, bidirectional=True
        )
